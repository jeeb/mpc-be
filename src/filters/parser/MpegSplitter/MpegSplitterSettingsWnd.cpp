...
bool CMpegSplitterSettingsWnd::OnActivate()
{
	...
	p.y += IPP_SCALE(15);
	m_cbTrueHD.Create(_T("TrueHD"), dwStyle | BS_AUTORADIOBUTTON | BS_TOP | BS_MULTILINE | WS_GROUP, CRect(p + CPoint(IPP_SCALE(30), 0),  CSize(IPP_SCALE(70), m_fontheight + 2)), this, IDC_PP_TRUEHD);
	m_cbAC3Core.Create(_T("AC-3 core"), dwStyle | BS_AUTORADIOBUTTON | BS_TOP | BS_MULTILINE, CRect(p + CPoint(IPP_SCALE(130), 0), CSize(IPP_SCALE(70), m_fontheight + 2)), this, IDC_PP_AC3CORE);
