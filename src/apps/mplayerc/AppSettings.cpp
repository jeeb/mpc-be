...
#define ADDCMD(cmd) wmcmds.AddTail(wmcmd##cmd)
	...
	ADDCMD((ID_NORMALIZE,						  0, FVIRTKEY|FNOINVERT,				IDS_TOGGLE_AUTO_GAIN_CONTROL));
...
void CAppSettings::SaveSettings()
{
	...
	pApp->WriteProfileInt(IDS_R_SETTINGS, IDS_RS_YOUTUBE_MB_MEM, iYoutubeMbMemory);
...
void CAppSettings::LoadSettings(bool bForce/* = false*/)
{
	...
	iRecentFilesNumber = max(0, (int)pApp->GetProfileInt(IDS_R_SETTINGS, IDS_RS_RECENT_FILES_NUMBER, 20));
