...
private:
	...
	void ParsePlayList(CString fn, CAtlList<CString>* subs, bool bCheck = true);
	void ParsePlayList(CAtlList<CString>& fns, CAtlList<CString>* subs, bool bCheck = true);
...
public:
	...
	void Open(CAtlList<CString>& fns, bool fMulti, CAtlList<CString>* subs = NULL, bool bCheck = true);
	void Append(CAtlList<CString>& fns, bool fMulti, CAtlList<CString>* subs = NULL, bool bCheck = true);
